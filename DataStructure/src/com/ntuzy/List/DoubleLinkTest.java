...
//        List
        ...
        System.out.println(str.getLastData());
    }
}
...
class List1<T> {
    ...
    private class Node {
        ...
        private void add(T data) {
            if (this.next == null) {
                ...
                List1.this.last = this.next;   // 将last指向最后一个添加的节点
            } else {
                this.next.add(data);
            }
        }
        ...
        private void remove(Node pre, T data) {
            if (this.data.equals(data)) {
                ...
                pre.next = this.next;
                this.next = null;
                if (List1.this.last.data.equals(data)) {
                    List1.this.last = pre;
                }
                List1.this.count--;
                return;
    ...
    public void addBefore(T data) {
        ...
        newNode.next = List1.this.root;
        List1.this.root = newNode;
        this.count++;
    }

    // addAfter 直接 将节点添加到last节点之后
